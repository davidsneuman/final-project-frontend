...
const EditStudentView = (props) => {
  ...
  // Render Edit Student view with an input form
  return (
    <div>
      <h1>Edit Student</h1>
      ...
      <div className={classes.root}>
        <div className={classes.formContainer}>
          ...
          <form style={{textAlign: 'center'}} onSubmit={(e) => handleSubmit(e)}>
            ...
            <input type="text" name="email" defaultValue={student.email} onChange={(e) => handleChange(e)} />
            <br/>
            <br/>
            ...
            <input type="number" step="0.01" name="gpa" defaultValue={student.gpa} onChange={(e) => handleChange(e)} />
            <br/>
            <br/>
